	<section class="content">
		...
		<div class="box-body table-responsive no-padding">
			<table id="tableList" class="table table-hover table-sidepad">
				...
				->addHeader('Email', array('class' => 'col-md-3'), 'sort', 'email')
				->addHeader('Number', array('class' => 'col-md-3'), 'sort', 'number')
				->addHeader('Subject', array('class' => 'col-md-3'), 'sort', 'subject')
				->addHeader('Message', array('class' => 'col-md-3'), 'sort', 'message')
				->draw();
				?>
