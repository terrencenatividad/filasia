		...
		<div class="box box-primary">
			...
			<div class="box-body table-responsive no-padding">
				<table id="tableList" class="table table-hover table-sidepad">
					...
					->addHeader('Mission Content', array('class' => 'col-md-3'), 'sort', 'mission_content', 'asc')
					->addHeader('Vision Content', array('class' => 'col-md-3'), 'sort', 'vision_content')
					->addHeader('Commitent Content', array('class' => 'col-md-3'), 'sort', 'commitment_content')
					->addHeader('Proven Technology Content', array('class' => 'col-md-3'), 'sort', 'tech_content')
					->draw();
					?>
