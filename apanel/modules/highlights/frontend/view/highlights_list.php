		...
		<div class = "row">
			<?php foreach($highlights_list as $high) : ?>
				<div class = "col-md-4 col-md-offset-1">
					<?php echo '<img id = "prod1" src="' . str_replace('/apanel', '', BASE_URL) . "uploads/items/thumb/".$high->image.'">' ?>
				</div>
				<div class = "col-md-5 col-md-offset-1">
					<h3 id = "three-d"><?php echo $high->title; ?></h3>
					<hr class = "divider">
					<h4 class = "textMargin"><?php echo $high->title; ?></h4>
				</div>
			<?php endforeach; ?>
		</div>
	</div>
