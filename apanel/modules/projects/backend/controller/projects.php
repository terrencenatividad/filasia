...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->view->header_active = 'projects/';
	}
	...
	public function listing() {
		...
		$this->view->load('projects/projects_list', $data);
	}
	...
	public function create() {
		...
		$this->view->load('projects/projects', $data);
	}

	public function edit($id) {
		$this->view->title = 'Highlights Edit';
		$data = (array) $this->projects->getProjectsById($this->fields, $id);
		$data['ui'] = $this->ui;
	...
	private function ajax_create() {
		...
		$data = $this->input->post($this->fields);
		$data['image'] = $filename;
		$result = $this->projects->saveProjects($data);
		return array(
			'redirect'	=> MODULE_URL,
			'success'	=> $result
			);
	...
	private function ajax_edit() {
		...
		$result = $this->projects->updateProjects($data, $id);
		return array(
			'redirect'	=> MODULE_URL,
			'success'	=> $result
			);
	...
	private function ajax_delete() {
		...
		$error_id = array();
		if ($delete_id) {
			$error_id = $this->projects->deleteProjects($delete_id);
		}
		return array(
	...
	private function ajax_list() {
		...
		$pagination = $this->projects->getProjects($this->fields, $sort, $search);
		$table = '';
